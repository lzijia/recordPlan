...
@Options({
  ...
  methods: {
    ...
    modPlan() {
      alert("this.planContentList[this.cardIndex - 1].itemName:"+this.planContentList[this.cardIndex - 1].itemName)
      alert("this.planContentList[this.cardIndex].itemName:"+this.planContentList[this.cardIndex.itemName)
      this.$router.push({
        path: "/newPlan",
        params: {
