...
import { oppositeBoolean, BooleanEnum } from "../common/enum/boolean";
  ...
  methods: {
    ...
    getPlanTypeContent() {
      ...
      while (isPlanTypeContent) {
        ...
        if (planTypeContentData != null) {
          //获取localStorage的计划类型
          this.planTypeContent[planTypeContentIndex - 1] =
            JSON.parse(planTypeContentData);
    ...
    confirm() {
      ...
      this.planTypeContent[id - 1] = JSON.parse(planTypeContent);
