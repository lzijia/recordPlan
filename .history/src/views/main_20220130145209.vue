...
@Options({
  ...
  methods: {
    ...
    completePlan() {
      ...
      let planDetailContentTitles =
        localStorage.getItem("planDetailContentTitles") == null
          ? ","
          : localStorage.getItem("planDetailContentTitles") + "";

      planDetailContentTitles +=
        this.planDetail.itemName + "-date-" + this.datetime;
      localStorage.setItem("planDetailContentTitles", planDetailContentTitles);
    ...
    exportPlanData() {
      ...
      axios.get("./data/datetimeType.json").then((res) => {
        ...
        //计划具体内容
        let planDetailContentItem = localStorage.getItem(
          "planDetailContentTitles"
        );
        if (planDetailContentItem) {
          let planDetailContentTitles = planDetailContentItem.split(",");
          console.log(planDetailContentTitles);
          for (let index in planDetailContentTitles) {
            console.log(planDetailContentTitles[index]);
            let planDetailContentTitle = planDetailContentTitles[index];
            planDetailContent +=
              planDetailContentTitle +
              localStorage.getItem(planDetailContentTitle) +
              "\n";
          }
        }
        alert(planDetailContent);
      });
    },
    importPlanData() {},
  },
